...
static PyCodeObject *codeobj_6b3eef2253ac46f16efe7493dab43249;

static void createModuleCodeObjects(void) {
    module_filename_obj = MAKE_RELATIVE_PATH(mod_consts[9]); CHECK_OBJECT(module_filename_obj);
    codeobj_6b3eef2253ac46f16efe7493dab43249 = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[10], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_6b3eef2253ac46f16efe7493dab43249;
    ...
    // Frame without reuse.
    frame_6b3eef2253ac46f16efe7493dab43249 = MAKE_MODULE_FRAME(codeobj_6b3eef2253ac46f16efe7493dab43249, module_main);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_6b3eef2253ac46f16efe7493dab43249);
    assert(Py_REFCNT(frame_6b3eef2253ac46f16efe7493dab43249) == 2);
    ...
    }
    {
        ...
        tmp_string_concat_values_1 = PyTuple_New(2);
        {
            ...
            tmp_format_value_1 = GET_STRING_DICT_VALUE(moduledict_main, (Nuitka_StringObject *)mod_consts[1]);
        ...
        frame_6b3eef2253ac46f16efe7493dab43249->m_frame.f_lineno = 1;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_6b3eef2253ac46f16efe7493dab43249);
#endif
    popFrameStack();

    assertFrameObject(frame_6b3eef2253ac46f16efe7493dab43249);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_6b3eef2253ac46f16efe7493dab43249, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_6b3eef2253ac46f16efe7493dab43249->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_6b3eef2253ac46f16efe7493dab43249, exception_lineno);
    }
